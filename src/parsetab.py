...
_lr_productions = [
  ...
  ('statement -> return_statement','statement',1,'p_statement','parser.py',30),
  ('statement -> call_statement','statement',1,'p_statement','parser.py',31),
  ('declaration -> type_specifier IDENTIFIER PUNCTUATION','declaration',3,'p_declaration','parser.py',38),
  ...
  ('assignment -> IDENTIFIER OPERATOR expression PUNCTUATION','assignment',4,'p_assignment','parser.py',52),
  ('expression -> NUMBER','expression',1,'p_expression','parser.py',64),
  ('expression -> IDENTIFIER','expression',1,'p_expression','parser.py',65),
  ('expression -> STRING','expression',1,'p_expression','parser.py',66),
  ('expression -> expression OPERATOR expression','expression',3,'p_expression_binop','parser.py',70),
  ('if_statement -> IF PUNCTUATION expression PUNCTUATION compound_stmt','if_statement',5,'p_if_statement','parser.py',77),
  ('if_statement -> IF PUNCTUATION expression PUNCTUATION compound_stmt ELSE compound_stmt','if_statement',7,'p_if_statement','parser.py',78),
  ('while_statement -> WHILE PUNCTUATION expression PUNCTUATION compound_stmt','while_statement',5,'p_while_statement','parser.py',89),
  ('return_statement -> RETURN expression PUNCTUATION','return_statement',3,'p_return_statement','parser.py',96),
  ('compound_stmt -> PUNCTUATION statement_list PUNCTUATION','compound_stmt',3,'p_compound_stmt','parser.py',105),
  ('call_statement -> function_name PUNCTUATION argument_list PUNCTUATION PUNCTUATION','call_statement',5,'p_call_statement','parser.py',112),
  ('function_name -> IDENTIFIER','function_name',1,'p_function_name','parser.py',117),
  ('function_name -> PRINTF','function_name',1,'p_function_name','parser.py',118),
  ('function_name -> SCANF','function_name',1,'p_function_name','parser.py',119),
  ('argument_list -> argument_list PUNCTUATION expression','argument_list',3,'p_argument_list','parser.py',126),
  ('argument_list -> expression','argument_list',1,'p_argument_list','parser.py',127),
  ('argument_list -> empty','argument_list',1,'p_argument_list','parser.py',128),
